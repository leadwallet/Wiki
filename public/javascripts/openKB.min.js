function show_notification(e, t, i) {
  (i = i || !1),
    $("#notify_message").removeClass(),
    $("#notify_message").addClass("notify_message-" + t),
...
$(document).ready(function () {
  function e() {
    ...
    i = i.replace(/<table/g, "<table class='table table-hover' ");
    var n = sanitizeHtml(i, {
      allowedTags: [
        "h1",
        "h2",
        "h3",
  ...
  if (
    ...
    !0 === config.links_blank_page &&
      $(".body_text a").attr("target", "_blank"),
    "undefined" != typeof mermaid && mermaid.initialize({ startOnLoad: !0 }),
    $("table").each(function () {
    ...
    $(document).on("change", "#kb_versions", function () {
      $.ajax({
        ...
        .done(function (e) {
          $("#frm_kb_title").val(e.kb_title),
            o.value(e.kb_body),
            $("#btnSettingsMenu").trigger("click");
        })
        .fail(function (e) {
          show_notification(e.responseText, "danger");
        });
    }),
    !0 === config.typeahead_search &&
      $("#frm_search").length &&
      $("#frm_search").on("keyup", function () {
        $("#frm_search").val().length > 2
          ? $.ajax({
              method: "POST",
    ...
    $(".toggle-menu").length &&
      $(".toggle-menu").jPushMenu({ closeOnClickOutside: !1 }),
    $("pre code").each(function (e, t) {
      hljs.highlightBlock(t);
    }),
    !0 === config.add_header_anchors &&
      $(
    ...
    $(window).scrollTop(i.offset().top).scrollLeft(i.offset().left);
  }
  if (
    ($("#frm_kb_keywords").length && $("#frm_kb_keywords").tokenfield(),
    $("#editor").length)
  ) {
    var o = new SimpleMDE({
      element: $("#editor")[0],
    ...
    inlineAttachment.editors.codemirror4.attach(o.codemirror, {
      uploadUrl: $("#app_context").val() + "/file/upload_file",
    }),
      e(),
      o.codemirror.on("change", function () {
        e();
      });
    ...
    if (null !== n) {
      var a = !1,
        l = !1;
      o.codemirror.on("scroll", function (e) {
        if (a) a = !1;
        else {
          l = !0;
        ...
        (n.onscroll = function () {
          if (l) l = !1;
            ...
            a = !0;
            var e = n.scrollHeight - n.clientHeight,
              t = parseFloat(n.scrollTop) / e,
              i =
                (o.codemirror.getScrollInfo().height -
                  o.codemirror.getScrollInfo().clientHeight) *
                t;
            o.codemirror.scrollTo(0, i);
          }
        });
    }
  }
  if (
    ($(document).on("click", "#frm_edit_kb_save", function (e) {
      e.preventDefault(),
        $("#versionSidebar").length && "" === $("#frm_kb_edit_reason").val()
          ? (show_notification(
    ...
    $(document).on("click", ".btnEditVersion", function (e) {
      $("#btnVersionMenu").trigger("click"),
        ...
        $.ajax({
          ...
          .fail(function (e) {
            $.LoadingOverlay("hide"), show_notification(e, "danger");
          });
    }),
    $(document).on("click", ".btnDeleteVersion", function (e) {
      var t = $(this).closest(".versionWrapper");
      $("#btnVersionMenu").trigger("click"),
        $.ajax({
          method: "POST",
          ...
          .fail(function (e) {
            show_notification(JSON.parse(e.responseText).message, "danger");
          });
    }),
    "true" === $("#frm_editor").val() &&
      $(window).bind("keydown", function (e) {
        (e.ctrlKey || e.metaKey) &&
          ...
          (e.preventDefault(), $("#frm_edit_kb_save").click());
      }),
      ...
      e && e.length > 5
        ? ($("#generate_permalink_from_title").removeClass("disabled"),
          $("#generate_permalink_from_title").click(function () {
            var e = $("#frm_kb_title").val();
            e && e.length > 5 && $("#frm_kb_permalink").val(t(e));
          }))
    ...
    var r = $("#input_notify_message").val(),
      c = $("#input_notify_message_type").val();
    $("#input_notify_message").val(""),
      $("#input_notify_message_type").val(""),
      show_notification(r, c, !1);
  }
}),
  $(document).on("click", ".file_delete_confirm", function (e) {
    e.preventDefault();
    var t = $(this).attr("data-id"),
      i = $(this).attr("data-path");
    window.confirm("Are you sure you want to delete the file?") &&
      $.ajax({
        method: "POST",
        ...
        .done(function (e) {
          $("#file-" + t).remove(), show_notification(e, "success");
        })
        .fail(function (e) {
          show_notification(e, "danger");
        });
  });
